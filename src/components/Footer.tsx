        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Impact Supply Aggregator Platform — connecting UMKM products from development programs to corporate
              buyers.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              ...
              <li>
                <Link to="/rfq" className="hover:text-accent transition-colors">
                  Request Quote
                </Link>
              </li>
            </ul>
