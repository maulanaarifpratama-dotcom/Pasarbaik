  ...
  <Html lang="id" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Gunakan kode di bawah untuk mengonfirmasi identitas Anda:</Text>
        <Text style={codeStyle}>{token}</Text>
        <Text style={footer}>
          Kode ini akan segera kedaluwarsa. Jika Anda tidak memintanya, abaikan email ini.
        </Text>
      </Container>
    </Body>
  </Html>
